...
namespace LINQ_Operators.List_Generator
{
    ...
    class Product : IComparable<Product>
    {
        ...
        public override string ToString()
            => $"ProductID: {ProductID}, ProductName: {ProductName}, Category: {Category}, UnitPrice:  {UnitPrice.ToString("C", new CultureInfo("en-US"))}, UnitsInStock: {UnitsInStock}";
